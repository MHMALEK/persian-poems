...
const MAIN_MENU_INTRO_HTML =
  ...
  "متن شعرها از <b>گنجور</b> خوانده می‌شود. زیر هر شعر می‌توانید همان صفحه را در وب باز کنید و با دکمه‌های پایین شعر بین بخش‌ها جابه‌جا شوید.\n\n" +
  "• <b>شاعران</b> — فهرست آثار هر شاعر\n" +
  "• <b>یک شعر تصادفی</b> — از چند شاعر در یک مجموعه\n" +
  "• <b>شعر روزانهٔ</b> —  روزانه یک شعر زیبا برای شما فرستاده می‌شود\n\n" +
